...
import {
  SignUpCorporateProps,
  signUpCorporateSchema,
} from "@/schemas/sign-up-corporate-schema";
...
export default function SignUpPersonal() {
  ...
  const form = useForm<SignUpCorporateProps>({
    defaultValues,
    resolver: zodResolver(signUpCorporateSchema),
  });
  ...
  const onSubmit = async (values: SignUpCorporateProps) => {
